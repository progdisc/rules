...
9. No advertisement (invite links, referral links, commercial products, etc.)
   unless explicitly asked, in which case links can be sent through the
   server. Discord server invite links will be removed automatically by
   Safety Jim for anti-spam measures, you must ask a moderator to share your
   server for you.
